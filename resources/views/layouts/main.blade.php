        ...
        <div id="wrapper">
            <header>
                ...
                <section id="action-bar">
                    <div id="logo">
                        <a href="#"><span id="logo-accent">e</span>Project Flyer</a>
                    </div><!-- end logo -->

                    <nav class="dropdown">
                        <ul>
                            <li>
                                <a href="#">Shop by Category <img src="{{ URL::asset('img/down-arrow.gif') }} " alt="Shop by Category" /></a>
                                <ul>
            ...
            <footer>
                ...
                <section class="clearfix">
                    ...
                    <div id="payments">
						...
						{!! HTML::image('img/payment-methods.gif', 'Supported payments method') !!}
                    </div><!-- end payments -->
                </section>
            </footer>
        </div><!-- end wrapper -->
